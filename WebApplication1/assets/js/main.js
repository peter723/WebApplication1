...
===============================================*/
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const menuToggleOpen = document.querySelector('.th-menu-toggle.open');
        const menuToggleClose = document.querySelector('.th-menu-toggle .fal.fa-times'); // Assuming it's inside the mobile wrapper
